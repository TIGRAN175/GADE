...
namespace tigran_ohannessian_task1
{
...

    {
        ...
        public Meleeunit(int CostofUnit, string name, string wenATKimage, int team, int x, int y, int health,
                         int attack, int atkRNG, int speed, int team2, int NAME)
        {
        ...
        public Meleeunit(int x, int y, int v1, int v2, int tempAttack, int v3, int team, string v4)
        {
            X = x;
            Y = y;
            this.x = v1;
        ...
        public override void fighting(int health, int attack, ref unit attack1, unit name)
        {
            throw new NotImplementedException();
        }

        public override bool rngcheck(int x, int y, ref unit attack)
        {
            throw new NotImplementedException();
        }
    }
